...
or input text. It does not prove retrieval quality or a workload role's
least-privilege IAM policy. Execution of this procedure is a Sprint 10
activation gate, not a Sprint 09 closure gate.
