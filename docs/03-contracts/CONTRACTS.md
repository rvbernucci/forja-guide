...
| [`retrieval-preflight-receipt.schema.json`](../../schemas/retrieval-preflight-receipt.schema.json) | Redacted bounded readiness proof for PostgreSQL, Qdrant, and the configured embedding provider |
